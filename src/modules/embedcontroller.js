...
const EmbedPage = require('../utils/embedpage.js');
...
class EmbedManager {
   ...
   * @param {object Array}  items    List of fields to add to the embed
   * @param {object}        settings Settings for the embed
   *
   */
  async addPage(message, items, settings) {
    ...
    // Create the embed
    const newEmbed = new EmbedPage(settings, 10);
